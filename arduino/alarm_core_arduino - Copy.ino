...
//#include "C:\source\repos\alarm\alarm-core\parseJSON.h" // Include the new header
...
char jsonString[16384];  // Create an empty string to store the file contents
...
initAlarmLoop()
    ...
    if (parseJsonConfig(jsonString, my_alarm)) {
